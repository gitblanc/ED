...
import tablas_hash.ClosedHashTableRedispersion;
...
public class CloseHashTableConRedispTest {
	...
	public void test() {
		...
		System.out.println(tabla.toString());
		assertEquals("{66};{_E_};{_E_};{_E_};{_E_};{_E_};{_E_};{_E_};{8};{_E_};{10};[Size: 11 Num.Elems.: 3]",
				tabla.toString());

		// Sigue insertando elementos
		assertEquals(true, tabla.add(77));
		System.out.println(tabla.toString());
		assertEquals("{66};{77};{_E_};{_E_};{_E_};{_E_};{_E_};{_E_};{8};{_E_};{10};[Size: 11 Num.Elems.: 4]",
				tabla.toString());
		...
		System.out.println(tabla.toString());
		assertEquals(
				"{_E_};{_E_};{_E_};{_E_};{_E_};{_E_};{_E_};{7};{77};{8};{9};{10};{_E_};{_E_};{_E_};{_E_};{_E_};{_E_};{_E_};{_E_};{66};{_E_};{_E_};[Size: 23 Num.Elems.: 6]",
				tabla.toString());

		// Borrar el 77
		assertEquals(true, tabla.remove(77));
		assertEquals(
				"{_E_};{_E_};{_E_};{_E_};{_E_};{_E_};{_E_};{7};{_D_};{8};{9};{10};{_E_};{_E_};{_E_};{_E_};{_E_};{_E_};{_E_};{_E_};{66};{_E_};{_E_};[Size: 23 Num.Elems.: 5]",
				tabla.toString());

		// Borrar el 9
		assertEquals(true, tabla.remove(9));
		assertEquals(
				"{_E_};{_E_};{_E_};{_E_};{_E_};{_E_};{_E_};{7};{_D_};{8};{_D_};{10};{_E_};{_E_};{_E_};{_E_};{_E_};{_E_};{_E_};{_E_};{66};{_E_};{_E_};[Size: 23 Num.Elems.: 4]",
				tabla.toString());
		...
		System.out.println(tabla.toString());
		assertEquals("{66};{_E_};{_E_};{_E_};{_E_};{_E_};{_E_};{7};{8};{_E_};{_E_};[Size: 11 Num.Elems.: 3]",
				tabla.toString());

		assertEquals(true, tabla.remove(66));
		System.out.println(tabla.toString());
		assertEquals("{_D_};{_E_};{_E_};{_E_};{_E_};{_E_};{_E_};{7};{8};{_E_};{_E_};[Size: 11 Num.Elems.: 2]",
				tabla.toString());
		...
		// Es el ultimo elemento. Nestor dice de no redispersar inversamente (no lo
		// entiendo)
